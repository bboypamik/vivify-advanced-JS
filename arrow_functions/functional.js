...
console.log(data.reduce((acc, current) => {
    if (!acc[current]){
        acc[current] = 1
    } else {
        acc[current]++
...
console.log(people.some( ({year}) => 2021 - year >= 19))
console.log(people.every( ({year}) => 2021 - year >= 19))
...
console.log(comments.filter(({id}) => id !== 823423))